...
export const AREAS: readonly Area[] = [
  ...
  { id: "vladivostok", name: "海参崴", kind: "land", points: [{ x: 78.5, y: 11.2 }] },
  ...
  { id: "caspian-sea", name: "里海", kind: "sea", points: [{ x: 50.6, y: 38.2 }] },
...
export const MAP_CONNECTIONS: readonly MapConnection[] = [
  ...
  ...borders("ukraine", "russia", "black-sea"),
  ...borders("russia", "siberia", "mongolia", "kazakhstan"),
  ...borders("siberia", "mongolia"),
  ...borders("vladivostok", "siberia", "mongolia", "north-pacific", "sea-of-japan"),
  ...borders("mongolia", "kazakhstan", "western-china", "eastern-china"),
  ...borders("kazakhstan", "western-china", "india"),
  ...borders("caspian-sea", "ukraine", "kazakhstan", "middle-east"),
